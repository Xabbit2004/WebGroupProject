                ...
                <?php
                    if(isset($_POST['searchButton'])){
                        ...
                        if(isset($_POST['search_type']) == 'byTitle'){
                            $search = "SELECT ISBN,TITLE,AUTHOR,PUBDATE, RATING,STATUS,EMAIL,CHECKDATE, EXPDATE FROM BOOKS
                            WHERE TITLE LIKE '%$searchText%'";
                        }
                        if(isset($_POST['search_type']) == 'byAuthor'){
                            $search = "SELECT ISBN,TITLE,AUTHOR,PUBDATE, RATING,STATUS,EMAIL,CHECKDATE, EXPDATE FROM BOOKS
                            WHERE AUTHOR LIKE '%$searchText%'";
                        }
                        if(isset($_POST['search_type']) == 'byISBN'){
                            $search = "SELECT ISBN,TITLE,AUTHOR,PUBDATE, RATING,STATUS,EMAIL,CHECKDATE, EXPDATE FROM BOOKS
                            WHERE ISBN LIKE '$searchText'";
                        }
                        if(isset($_POST['search_type']) == 'byEmail'){
                            $search = "SELECT ISBN,TITLE,AUTHOR,PUBDATE, RATING,STATUS,EMAIL,CHECKDATE, EXPDATE FROM BOOKS
